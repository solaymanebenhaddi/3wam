        ...
        <div className="faq-list">
          <ul>
            <li data-aos="fade-up" data-aos-delay="100">
              <i className="bx bx-help-circle icon-help"></i> <a href='/#' data-bs-toggle="collapse" className="collapse" data-bs-target="#faq-list-1">Qui est la 3W Academy Maroc ? <i className="bx bx-chevron-down icon-show"></i><i className="bx bx-chevron-up icon-close"></i></a>
            ...
            <li data-aos="fade-up" data-aos-delay="200">
              <i className="bx bx-help-circle icon-help"></i> <a href='/#' data-bs-toggle="collapse" data-bs-target="#faq-list-2" className="collapsed">Une Formation en mode Bootcamp, c’est quoi ? <i className="bx bx-chevron-down icon-show"></i><i className="bx bx-chevron-up icon-close"></i></a>
            ...
            <li data-aos="fade-up" data-aos-delay="300">
              <i className="bx bx-help-circle icon-help"></i> <a href='/#' data-bs-toggle="collapse" data-bs-target="#faq-list-3" className="collapsed">Peut-on devenir développeur Web en 4 mois ? <i className="bx bx-chevron-down icon-show"></i><i className="bx bx-chevron-up icon-close"></i></a>
            ...
            <li data-aos="fade-up" data-aos-delay="400">
              <i className="bx bx-help-circle icon-help"></i> <a href='/#' data-bs-toggle="collapse" data-bs-target="#faq-list-4" className="collapsed">Qui sont les formateurs chez la 3W Academy Maroc ? <i className="bx bx-chevron-down icon-show"></i><i className="bx bx-chevron-up icon-close"></i></a>
            ...
            <li data-aos="fade-up" data-aos-delay="500">
              <i className="bx bx-help-circle icon-help"></i> <a href='/#' data-bs-toggle="collapse" data-bs-target="#faq-list-5" className="collapsed">Pourquoi un Bootcamp plutôt qu’une formation classique ? <i className="bx bx-chevron-down icon-show"></i><i className="bx bx-chevron-up icon-close"></i></a>
            ...
            <li data-aos="fade-up" data-aos-delay="500">
              <i className="bx bx-help-circle icon-help"></i> <a href='/#' data-bs-toggle="collapse" data-bs-target="#faq-list-5" className="collapsed">Quelles sont les débouchés de vos formations ? <i className="bx bx-chevron-down icon-show"></i><i className="bx bx-chevron-up icon-close"></i></a>
              <div id="faq-list-5" className="collapse" data-bs-parent=".faq-list">
                <p>
            ...
            <li data-aos="fade-up" data-aos-delay="500">
              <i className="bx bx-help-circle icon-help"></i> <a href='/#' data-bs-toggle="collapse" data-bs-target="#faq-list-5" className="collapsed">Je n'ai jamais touché au code auparavant, est-ce fait pour moi ? <i className="bx bx-chevron-down icon-show"></i><i className="bx bx-chevron-up icon-close"></i></a>
              <div id="faq-list-5" className="collapse" data-bs-parent=".faq-list">
                <p>
            ...
            <li data-aos="fade-up" data-aos-delay="500">
              <i className="bx bx-help-circle icon-help"></i> <a href='/#' data-bs-toggle="collapse" data-bs-target="#faq-list-5" className="collapsed">Comment se fait l’évaluation des acquis des apprenants ? <i className="bx bx-chevron-down icon-show"></i><i className="bx bx-chevron-up icon-close"></i></a>
              <div id="faq-list-5" className="collapse" data-bs-parent=".faq-list">
                <p>
            ...
            <li data-aos="fade-up" data-aos-delay="500">
              <i className="bx bx-help-circle icon-help"></i> <a href='/#' data-bs-toggle="collapse" data-bs-target="#faq-list-5" className="collapsed">Quelle est la différence entre une formation en téléprésentiel et une formation en ligne classique ? <i className="bx bx-chevron-down icon-show"></i><i className="bx bx-chevron-up icon-close"></i></a>
              <div id="faq-list-5" className="collapse" data-bs-parent=".faq-list">
                <p>
            ...
            <li data-aos="fade-up" data-aos-delay="500">
              <i className="bx bx-help-circle icon-help"></i> <a href='/#' data-bs-toggle="collapse" data-bs-target="#faq-list-5" className="collapsed">De quoi j’ai besoin pour suivre une formation en téléprésentiel ? <i className="bx bx-chevron-down icon-show"></i><i className="bx bx-chevron-up icon-close"></i></a>
              <div id="faq-list-5" className="collapse" data-bs-parent=".faq-list">
                <p>
